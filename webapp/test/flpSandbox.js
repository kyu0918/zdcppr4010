		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#synczdcppr4010-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"synczdcppr4010-display": {
								"semanticObject": "synczdcppr4010",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.zdcppr4010",
									"url": sap.ui.require.toUrl("sync/zdcppr4010")
								}
							}
						}
					}
